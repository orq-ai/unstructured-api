...
class UnstructuredProcessChunksCommand(KnowledgeCommand):
    ...
    data: Dict[str, Any] = Field(..., json_schema_extra={"example": {"chunks": [{"type": "Text", "element_id": "chunk_0", "metadata": {"chunk_index": 0, "total_chunks": 1, "type": "text", "coordinates": None, "page_number": None, "words_count": 10, "sentences_count": 1, "paragraphs_count": 1, "tokens_count": 10, "characters_count": 50}, "text": "string"}], "originalCommandId": "string"}}) 