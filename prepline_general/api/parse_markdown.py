...
from prepline_general.api.models.knowledge import (
    Chunk,
    ChunkMetadata,
    ChunkingOptions,
...
async def parse_markdown(
    ...
    _workspace_id: str = Depends(require_orq_workspace),
):
    try:
        ...
        for i, chunk in enumerate(chunks):
            ...
            processed_chunk = Chunk(
                text=chunk["content"], type=chunk["metadata"]["type"], metadata=chunk_metadata
            )
